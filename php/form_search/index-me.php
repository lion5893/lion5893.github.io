...
<header class="intro">
    <div class="intro-body">
        <div class="container">
            ...
            <?php
//          In ra màn hình thông tin nhập vào
                if(!empty($_GET)){
                    // Tìm các user có chuỗi trùng với cụm từ tìm kiếm rồi đẩy vào mảng result
                    $query = $_GET["query"];
                    $result = [];
                    ...
                    // In ra màn hình tìm kiếm được bao nhiêu kết quả
                    echo '<div class = "row">
                    <h2> Tìm thấy ' . count($result) . ' kết quả </h2></div' ;
                    // In ra màn hình các kết quả tìm được
                    echo '<div class="col-md-8 col-md-offset-2 search-result"
                                <div class="row"></div>';
                    foreach ($result as $r){
                        echo '<div class="col-md-6 col-sm-6 result-box"> 
                                    <img src="' . $result["avatar"] . '"class = "img img-responsive img-thumbnail avatar">
                                    <h4 class="user-name">' . $r["name"] . '</h4
                                    <span class="user-age">' . $r["age"] . ' years old</span></div>';
                        //'<div class="col-md-6 col-sm-6 result-box"><img src="' là 1 chuỗi
                    }
                    echo '</div>';
                }
            ?>
