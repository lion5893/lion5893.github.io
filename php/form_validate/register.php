...
//                echo "</pre>";
                $success = true;
                // Hàm isset kiểm tra dữ liệu đã được post lên hay chưa, nếu đã post rồi thì kiểm tra nó có rỗng hay không
...
<!--                            </div>-->
                            <div class="form-group">
                                <label for="agree" style="color: #fff">
                                    <input type="radio" name="agree" id="agree" value="agree" required> I agree to the Terms and Conditions
                                </label>
                            </div>
